...
public:
    int minMutation(string start, string end, vector<string>& bank)
    {
        ...
        if(bankDict.find(end) == bankDict.end()) return -1;
...
{
    Solution s;
    vector<string> a{"AAAAAAAA","AAAAAAAC","AAAAAACC","AAAAACCC","AAAACCCC","AACACCCC","ACCACCCC","ACCCCCCC","CCCCCCCA"};
    std::cout<<s.minMutation("AAAAAAAA", "CCCCCCCC", a)<<std::endl;
}
